...
public class MovieDetailViewModel extends AndroidViewModel {
        ...
        Disposable disposable = movieDao.insertMovie(movie)
                ...
                .doOnError(new Consumer<Throwable>() {
                    ...
                    public void accept(Throwable throwable) throws Throwable {
                        Log.d(TAG, "Error on inserting movie.");
                    }
                })
    ...
    public void removeMovie(int movieId){
        Disposable disposable = movieDao.removeMovie(movieId)
                ...
                .doOnError(new Consumer<Throwable>() {
                    @Override
                    public void accept(Throwable throwable) throws Throwable {
                        Log.d(TAG, "Error on removing movie.");
                    }
                })
                .subscribe(new Action() {
                    @Override
    ...
    public void loadTrailers(int id){
        Disposable disposable =  RetrofitInstance.apiService.loadTrailers(id)
                .subscribeOn(Schedulers.io())
    ...
    public void loadReviews(int id){
        Disposable disposable =  RetrofitInstance.apiService.loadReviews(id, page)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
